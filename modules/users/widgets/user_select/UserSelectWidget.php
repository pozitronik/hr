 ...
 *
 * @fixme: действительно, плохо спроектировал. Привязка к модели для автоматической генерации имени поля заодно вытаскивает и данные этой модели для отображения. Пока пользоваться можно, но лучше переделать.
 */
