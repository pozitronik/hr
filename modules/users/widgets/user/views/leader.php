		...
		<div class="panel user">
			<?php if ($group->isLeader($model)): ?>
				<div class="crown text-center pull-left">
					<?= Users::a(Html::img($model->avatar, ['class' => "img-sm {$borderStyle} img-circle", 'alt' => $model->username]), ['users/profile', 'id' => $model->id]) ?>
				</div>
			...
			<div class="mar-btm pull-left">
				<span class="text-semibold text-main"><?= Users::a($model->username, ['users/profile', 'id' => $model->id]) ?></span>
