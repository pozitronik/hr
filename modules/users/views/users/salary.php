			...
			<div class="row">
				...
				<div class="col-md-2">
					<?= $form->field($model, 'relGrade')->widget(RefDepDrop::class, [
						...
						'data' => null === $model->relUsersSalary->grade_id?ArrayHelper::map(ArrayHelper::getValue($model->relRefUserPositions, 'relRefGrades'), 'id', 'name'):[$model->relUsersSalary->grade_id => ArrayHelper::getValue($model, 'relGrade.name')],
