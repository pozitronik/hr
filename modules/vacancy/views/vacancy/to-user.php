					...
					'columns' => [
						...
						[
							...
							'value' => BadgeWidget::widget([
								'models' => $model->getRelRefVacancyRecruiter()->all(),//здесь нельзя использовать свойство, т.к. фреймворк не подгружает все релейшены в $_related сразу. Выяснено экспериментально, на более подробные разбирательства нет времени
								'useBadges' => true,
								'attribute' => 'name',
								'unbadgedCount' => 6,
				...
				[
					'columns' => [
						...
						[
							...
							'format' => 'raw',
							'value' => BadgeWidget::widget([
								'models' => $model->getRelRefSalaryPremiumGroup()->all(),//здесь нельзя использовать свойство, т.к. фреймворк не подгружает все релейшены в $_related сразу. Выяснено экспериментально, на более подробные разбирательства нет времени
								'useBadges' => true,
								'attribute' => 'name',
								'unbadgedCount' => 6,
								"itemsSeparator" => false,
						...
						[
							...
							'format' => 'raw',
							'value' => BadgeWidget::widget([
								'models' => $model->getRelRefLocation()->all(),//здесь нельзя использовать свойство, т.к. фреймворк не подгружает все релейшены в $_related сразу. Выяснено экспериментально, на более подробные разбирательства нет времени
								'useBadges' => false,
								'attribute' => 'name',
								'unbadgedCount' => 6,
								"itemsSeparator" => false,
				...
				[
					'columns' => [
						[
							...
							'format' => 'raw',
							'value' => BadgeWidget::widget([
								'models' => $model->getRelEmployer()->all(),//здесь нельзя использовать свойство, т.к. фреймворк не подгружает все релейшены в $_related сразу. Выяснено экспериментально, на более подробные разбирательства нет времени
								'useBadges' => false,
								'attribute' => 'username',
								'unbadgedCount' => 6,
								"itemsSeparator" => false
						...
						[
							...
							'format' => 'raw',
							'value' => BadgeWidget::widget([
								'models' => $model->getRelTeamlead()->all(),//здесь нельзя использовать свойство, т.к. фреймворк не подгружает все релейшены в $_related сразу. Выяснено экспериментально, на более подробные разбирательства нет времени
								'useBadges' => false,
								'attribute' => 'username',
								'unbadgedCount' => 6,
								"itemsSeparator" => false
