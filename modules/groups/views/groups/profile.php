...
$this->registerJs("var graphControl = new GraphControl(_.$('group-profile-tree-container'), {$model->id}, -1, -1, -1); graphControl.physics = false; graphControl.autofit = false; graphControl.resizeContainer(); graphControl.fitAnimated(true);", View::POS_END);
