...
class m190827_072210_new_fos_columns extends Migration {
	...
	public function safeUp() {
		...
		$this->addColumn('import_fos', 'owner_th', $this->string()->after('command_type')->comment('ТН владельца продукта'));
		...
		$this->createIndex('owner_th', 'import_fos', 'owner_th');
	...
	public function safeDown() {
		...
		$this->dropColumn('import_fos', 'owner_th');
