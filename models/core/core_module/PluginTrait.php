...
trait PluginTrait {
	...
	public static function a(string $text, $url = null, array $options = []):string {
		...
		/*По логике, такое падение означает отсутсвие модуля, на который происходит ссылка. Вместо этого можно выдавать заглушку, типа "доставьте", или делать ссылку неактивной*/
